_registerTranslations("en", {
    ...
    "measures.new_title": "New measure",
    ...
    "dashboard.derogated": "Under derogation",
    "dashboard.derogated_help": "Neither open nor handled: accepted for a bounded time",
    "dashboard.low": "Low",
    ...
    "findings.status_derogated": "Under derogation",
    "findings.status_derogated_help": "An approved derogation covers this finding: it stays silent until it expires or is revoked.",
    ...
    "help.methodo_html": "<h1 class=\"heading-blue\">AppSec (SAST/SCA) — Methodology</h1>"
        ...
        + "<div class=\"ct-help-tip\"><strong>Doctrine:</strong> a secret present in Git history is considered compromised, even if removed in a later commit. The only valid remediation is <strong>rotation</strong>; deleting it from the code is not enough.</div>"
    ...
    "help.usage_html": "<h1 class=\"heading-blue\">AppSec (SAST/SCA) — User Guide</h1>\n\n<h2>Features requiring AI</h2>\n<p>These features call a language model and are only available once AI is configured. They are <strong>optional</strong>: without configuration they are hidden or inactive and the rest of the module works normally.</p>\n<ul>\n<li><strong>AI analysis of a finding</strong>: triage recommendation, with a <em>deep analysis</em> option that feeds more context to the model</li>\n</ul>\n<p class=\"ct-help-tip\">Where to configure: in a standalone install, through the module's <strong>Settings &rarr; AI</strong> (your own API key). In the suite, keys are centralised by <strong>Pilot</strong> and pushed to the modules &mdash; nothing to enter here, and AI access is granted per user in the permissions matrix.</p>"
        ...
        + "<div class=\"ct-help-tip\"><strong>Warning:</strong> deleting an application also deletes all its findings.</div>"
        + "<h2>3. Findings</h2>"
        ...
        + "<div class=\"ct-help-tip\"><strong>Tip:</strong> the list opens filtered on the <strong>New</strong> status. Click \"All statuses\" to also see already-triaged findings.</div>"
