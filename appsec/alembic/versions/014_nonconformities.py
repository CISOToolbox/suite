...
Revision ID: 014_nonconformities
Revises: 013_code_finding_identity
Create Date: 2026-09-21

Two new tables shared in shape with every module — declared non-conformities
(with every item they concern) and time-boxed derogations — and the column
that ties a finding to the derogation covering it while its status is
`derogated`.
"""
...
revision = "014_nonconformities"
down_revision = "013_code_finding_identity"
branch_labels = None
depends_on = None
