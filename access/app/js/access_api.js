...
(function () {
    ...
    function _pid() { return (window.getActiveProjectId && window.getActiveProjectId()) || ""; }
    window.AccessAPI = {
        ...
        // SI Users
        listSiUsers: function (pid) { return _fetch("/projects/" + pid + "/si-users"); },
        createSiUser: function (pid, data) { return _fetch("/projects/" + pid + "/si-users", { method: "POST", body: data }); },
        patchSiUser: function (pid, uid, fields) { return _fetch("/projects/" + pid + "/si-users/" + uid, { method: "PATCH", body: fields }); },
        deleteSiUser: function (pid, uid) { return _fetch("/projects/" + pid + "/si-users/" + uid, { method: "DELETE" }); },
        syncSiUsersFromPilot: function (pid) { return _fetch("/projects/" + pid + "/si-users/sync-from-pilot", { method: "POST" }); },
        importSiUsersCsv: function (pid, file) { var fd = new FormData(); fd.append("file", file); return _fetch("/projects/" + pid + "/si-users/import-csv", { method: "POST", body: fd, headers: {} }); },
        syncSiUsersFromHr: function (pid) { return _fetch("/projects/" + pid + "/si-users/sync-hr", { method: "POST" }); },
        listEntitlements: function (pid, uid) { return _fetch("/projects/" + pid + "/si-users/" + uid + "/entitlements"); },
        listEntitlementAudit: function (pid, uid) { return _fetch("/projects/" + pid + "/si-users/" + uid + "/entitlements/audit"); },
        createEntitlement: function (pid, uid, data) { return _fetch("/projects/" + pid + "/si-users/" + uid + "/entitlements", { method: "POST", body: data }); },
        deleteEntitlement: function (pid, uid, eid) { return _fetch("/projects/" + pid + "/si-users/" + uid + "/entitlements/" + eid, { method: "DELETE" }); },
        // Applications
        listApps: function (pid) { return _fetch("/projects/" + pid + "/applications"); },
        createApp: function (pid, data) { return _fetch("/projects/" + pid + "/applications", { method: "POST", body: data }); },
        patchApp: function (pid, aid, fields) { return _fetch("/projects/" + pid + "/applications/" + aid, { method: "PATCH", body: fields }); },
        deleteApp: function (pid, aid) { return _fetch("/projects/" + pid + "/applications/" + aid, { method: "DELETE" }); },
        importAppsCsv: function (pid, file) { var fd = new FormData(); fd.append("file", file); return _fetch("/projects/" + pid + "/applications/import-csv", { method: "POST", body: fd, headers: {} }); },
        syncAppsFromAsset: function (pid) { return _fetch("/projects/" + pid + "/applications/sync-asset", { method: "POST" }); },
        // Reviews
        listReviews: function (pid, status) { return _fetch("/projects/" + pid + "/reviews" + (status ? "?status=" + status : "")); },
        getReview: function (pid, rid) { return _fetch("/projects/" + pid + "/reviews/" + rid); },
        createReview: function (pid, data) { return _fetch("/projects/" + pid + "/reviews", { method: "POST", body: data }); },
        importCsv: function (pid, rid, file) { var fd = new FormData(); fd.append("file", file); return _fetch("/projects/" + pid + "/reviews/" + rid + "/import-csv", { method: "POST", body: fd, headers: {} }); },
        patchEntry: function (pid, rid, eid, fields) { return _fetch("/projects/" + pid + "/reviews/" + rid + "/entries/" + eid, { method: "PATCH", body: fields }); },
        closeReview: function (pid, rid) { return _fetch("/projects/" + pid + "/reviews/" + rid + "/close", { method: "POST" }); },
        exportReview: function (pid, rid) { return BASE + "/projects/" + pid + "/reviews/" + rid + "/export"; },
        deleteReview: function (pid, rid) { return _fetch("/projects/" + pid + "/reviews/" + rid, { method: "DELETE" }); },
        // Measures
        listMeasures: function (pid) { return _fetch("/projects/" + pid + "/measures"); },
        // FEAT-45 — non-conformities and derogations (module-wide, not per project)
        ...
        createMeasure: function (pid, data) { return _fetch("/projects/" + pid + "/measures", { method: "POST", body: data }); },
        patchMeasure: function (pid, mid, fields) { return _fetch("/projects/" + pid + "/measures/" + mid, { method: "PATCH", body: fields }); },
        deleteMeasure: function (pid, mid) { return _fetch("/projects/" + pid + "/measures/" + mid, { method: "DELETE" }); },
        // Service Accounts
        listServiceAccounts: function (pid) { return _fetch("/projects/" + pid + "/service-accounts"); },
        createServiceAccount: function (pid, d) { return _fetch("/projects/" + pid + "/service-accounts", { method: "POST", body: d }); },
        patchServiceAccount: function (pid, id, f) { return _fetch("/projects/" + pid + "/service-accounts/" + id, { method: "PATCH", body: f }); },
        deleteServiceAccount: function (pid, id) { return _fetch("/projects/" + pid + "/service-accounts/" + id, { method: "DELETE" }); },
        // Plugins
        listAvailablePlugins: function () { return _fetch("/plugins/available"); },
        listPlugins: function (pid) { return _fetch("/projects/" + pid + "/plugins"); },
        createPlugin: function (pid, d) { return _fetch("/projects/" + pid + "/plugins", { method: "POST", body: d }); },
        patchPlugin: function (pid, id, f) { return _fetch("/projects/" + pid + "/plugins/" + id, { method: "PATCH", body: f }); },
        deletePlugin: function (pid, id) { return _fetch("/projects/" + pid + "/plugins/" + id, { method: "DELETE" }); },
        testPlugin: function (pid, id) { return _fetch("/projects/" + pid + "/plugins/" + id + "/test", { method: "POST" }); },
        testPluginConfig: function (pid, body) { return _fetch("/projects/" + pid + "/plugins/test-config", { method: "POST", body: body }); },
        importReviewFromConnector: function (pid, rid, body) { return _fetch("/projects/" + pid + "/reviews/" + rid + "/import-connector", { method: "POST", body: body || {} }); },
        importReviewFromConnectorFile: function (pid, rid, file, pluginId) { var fd = new FormData(); fd.append("file", file); if (pluginId)
            fd.append("plugin_id", pluginId); return _fetch("/projects/" + pid + "/reviews/" + rid + "/import-connector-file", { method: "POST", body: fd, headers: {} }); },
        pluginHistory: function (pid, id) { return _fetch("/projects/" + pid + "/plugins/" + id + "/history"); },
        // AI
        aiComplete: function (sys, usr, prov, model) { return _fetch("/ai/complete", { method: "POST", body: { system: sys, user: usr, provider: prov || (window._aiRuntime && window._aiRuntime.provider) || "anthropic", model: model || (window._aiRuntime && window._aiRuntime.model) || "claude-sonnet-4-6" } }); },
    ...
    if (_origLoadBuffer) {
        ...
        window._loadBuffer = function (buffer, filename) {
            ...
            setTimeout(function () {
                if (_activeId) {
                    AccessAPI.saveFull(_activeId, D);
                }
                else {
                    AccessAPI.create({ name: (D.metadata && D.metadata.organization) || "", data: JSON.parse(JSON.stringify(D)) }).then(function (p) { _activeId = p.id; localStorage.setItem("access_active_project", _activeId); });
                }
            }, 200);
        };
    }
    window._appInitCallback = function () {
        ...
        function _showAccessDeniedPage() {
            var html = ''
    ...
    document.addEventListener("visibilitychange", function () {
        if (document.visibilityState !== "visible" || !_activeId || _saveTimer)
            return;
        AccessAPI.get(_activeId).then(function (project) {
