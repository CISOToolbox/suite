"""SMTP sender for Access service-account expiry alerts (FEAT-42).
...
first, then environment variables (standalone mode) — identical to Asset and
Watch.
"""
...
_DEFAULT_FROM = "access@cisotoolbox.local"
