...
Revision ID: 020_nonconformities
Revises: 019_sa_expiration_app_owner
Create Date: 2026-09-21

Two new tables shared in shape with every module: declared non-conformities
(with every item they concern) and time-boxed derogations. A derogation
covers a review entry through its key (project, review, entry); the entry's
decision says `derogated` meanwhile.
"""
from alembic import op
import sqlalchemy as sa
from sqlalchemy.dialects.postgresql import JSONB, UUID

revision = "020_nonconformities"
down_revision = "019_sa_expiration_app_owner"
branch_labels = None
depends_on = None
