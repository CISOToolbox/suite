...
Revision ID: 009_nonconformities
Revises: 008_owner_set_null
Create Date: 2026-09-13

Two new tables shared in shape with every module: declared non-conformities
and time-boxed derogations. A derogation covers a control through its
business key (framework:ref); the control row itself is untouched.
"""
from alembic import op
import sqlalchemy as sa
from sqlalchemy.dialects.postgresql import JSONB, UUID

revision = "009_nonconformities"
down_revision = "008_owner_set_null"
branch_labels = None
depends_on = None
