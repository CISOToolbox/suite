...
Revision ID: 004_measure_progress_log
Revises: 003_canonical_project
...
revision = "004_measure_progress_log"
down_revision = "003_canonical_project"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    op.drop_column("project_measures", "progress_log")
