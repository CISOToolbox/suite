...
_registerTranslations("fr", {
    ...
    "comp.nc.create_control_failed": "Contrôle non créé : {msg}",
...
"comp.fw.deactivate": "Désactiver seulement",
"comp.fw.off_or_delete": "« {label} » est un référentiel que vous avez importé. Le désactiver le retire de l'évaluation en gardant son contenu ; le supprimer l'efface définitivement.",
"comp.fw.delete": "Supprimer le référentiel",
"comp.fw.deleted": "{label} supprimé",
"comp.fw.delete_refused_register": "Suppression refusée : {count} enregistrement(s) du registre désignent une exigence de ce référentiel",
"comp.fw.delete_refused": "Suppression refusée : {count} exigence(s) de ce référentiel sont évaluées",
"comp.fw.delete_failed": "Le référentiel n'a pas pu être supprimé",
"comp.fw.delete_unavailable": "Suppression indisponible dans cette version",
"comp.csv.btn_import": "Importer un referentiel (CSV)",
    ...
    "comp.csv.error_save": "Le referentiel n'a pas pu etre enregistre — rien n'a ete importe",
