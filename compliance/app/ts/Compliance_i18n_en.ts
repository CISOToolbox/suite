...
_registerTranslations("en", {
    ...
    "matrix.x": "Impact",
    "matrix.y": "Likelihood",
"comp.fw.deactivate": "Deactivate only",
"comp.fw.off_or_delete": "\"{label}\" is a framework you imported. Deactivating removes it from the assessment and keeps its content; deleting erases it for good.",
"comp.fw.delete": "Delete framework",
"comp.fw.deleted": "{label} deleted",
"comp.fw.delete_refused_register": "Refused: {count} record(s) of the register name a requirement of this framework",
"comp.fw.delete_refused": "Refused: {count} requirement(s) of this framework carry an assessment",
"comp.fw.delete_failed": "The framework could not be deleted",
"comp.fw.delete_unavailable": "Deletion is not available in this build",
"comp.csv.btn_import": "Import framework (CSV)",
    ...
    "comp.csv.error_save": "The framework could not be saved — nothing was imported",
